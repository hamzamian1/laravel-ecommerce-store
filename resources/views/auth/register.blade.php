    ...
    <div class="main-content">
        <div class="register-card">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input type="email" name="email" class="input-field" placeholder="E-mail" value="{{ old('email') }}" required autocomplete="email">
                    @if($errors->has('email'))
                ...
                <button type="submit" class="register-btn" onclick="document.getElementById('full_name').value = document.getElementsByName('first_name')[0].value + ' ' + document.getElementsByName('last_name')[0].value">Create Account</button>
            </form>
